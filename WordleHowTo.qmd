...
The collins-scrabble-words-2019 has a total of 279,496 words, of these 12,972 are 5-letter words

The google-10000-english-usa-no-swears has a total of 9,884 words, of these 1,210 are 5-letter words

By using the intersect() function to ensure that the list of words is made of only of words present in path lists, we narrow down out list of total words to 8,336 words.
...
In order to play the game, the user runs this line of code which calls the play_wordle function with all the necessary arguments. I have my code set up as a comment right now because when I tried to render this page with it active, the loading got stuck at 92% FOREVER. I took my dog for a 15 minute walk and it was still on 92% but having it as a comment allowed the document to render right away. If the user wants to play the game they can just remove the \# in their R-Studio
