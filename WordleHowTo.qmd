...
valid_list <- load_dictionary("collins-scrabble-words-2019.txt") #starts with 279496 observations
solution_list1 <- load_dictionary("google-10000-english-usa-no-swears.txt") #starts at 9884 observations
str(valid_list)
str(solution_list)

solution_list <- intersect(valid_list, solution_list) #brings it down to 8336 observatuions
```
